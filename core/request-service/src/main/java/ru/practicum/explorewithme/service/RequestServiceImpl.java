...
import ru.practicum.explorewithme.feign.EventClient;
import ru.practicum.explorewithme.feign.UserClient;
import ru.practicum.explorewithme.model.Request;
import ru.practicum.explorewithme.model.RequestMapper;
import ru.practicum.explorewithme.model.Status;
import ru.practicum.explorewithme.repository.RequestCountProjection;
...
public class RequestServiceImpl implements RequestService {
    ...
    public ParticipationRequestDto addUserRequest(Long requesterId, Long eventId) {
        ...
        collectorClient.sendRegister(event.getId(), user.getId());
